...
import HeartIconcopy from "../assets/HeartIconcopy.svg";
import HeartOutlineIconcopy from "../assets/HeartOutlineIconcopy.svg";
import { User } from "../Components/types"; // adjust path as needed
...
const LikeButtonSmall: React.FC<LikeButtonProps> = ({
  ...
  return (
    <div className="middle-heart">
      <p className="number-count">{currentLikeCount}</p>
      <button
        onClick={handleLike}
      ...
      >
        <img
          src={isLiked ? HeartIconcopy : HeartOutlineIconcopy}
          alt={isLiked ? "Liked" : "Not liked"}
          className={`small-heart-small${isLiked ? " animate" : ""}`}
          style={{
