  ...
  return (
    <div className="container">
      ...
      <div className="second-header">
        <div className="inside-second-header">
          <div className="tittle-sec">
            <p>New Images</p>
          </div>
          <div className="header-nav">
            <div className="tabs3">
              <div className="tab3">Right now</div>
              <div className="tab3">Yesterday</div>
              <div className="tab3">last week</div>
              <div className="tab3">Last month</div>
            </div>
          </div>
        </div>
      </div>
